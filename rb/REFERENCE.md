# Argentofx Ruby SDK Reference

Complete API reference for the Argentofx Ruby SDK.
...
#### `ArgentofxSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.DollarQuote.list(nil)
```
