...
from argentofx_sdk.utility import register

# Load features
from argentofx_sdk.feature.base_feature import ArgentofxBaseFeature
from argentofx_sdk.features import _has_feature, _make_feature
...
class ArgentofxSDK:
    ...
    def get_utility(self):
        return ArgentofxUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ArgentofxSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Currency(self, data=None) -> "CurrencyEntity":
        ...
        from argentofx_sdk.entity.currency_entity import CurrencyEntity
    ...
    def DollarQuote(self, data=None) -> "DollarQuoteEntity":
        ...
        from argentofx_sdk.entity.dollar_quote_entity import DollarQuoteEntity
    ...
    def GetRoot(self, data=None) -> "GetRootEntity":
        ...
        from argentofx_sdk.entity.get_root_entity import GetRootEntity
