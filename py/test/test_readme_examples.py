# Argentofx SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ArgentofxSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ArgentofxSDK(...) and ArgentofxSDK.test(...) become
#      ArgentofxSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "argentofx_sdk"
_SDK_CLASS = "ArgentofxSDK"
