...
class GetRootEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ARGENTOFX_TEST_GET_ROOT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function get_root_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ARGENTOFX_TEST_GET_ROOT_ENTID");
