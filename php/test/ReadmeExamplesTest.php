...
// Argentofx SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ArgentofxSDK::test)
...
{
    private const SDK_CLASS = 'ArgentofxSDK';
    ...
    private const SDK_BASE = 'argentofx_sdk';
