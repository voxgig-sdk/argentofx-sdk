...
class CurrencyEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = ArgentofxSDK::test($seed, null);
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ARGENTOFX_TEST_CURRENCY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function currency_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ARGENTOFX_TEST_CURRENCY_ENTID");
