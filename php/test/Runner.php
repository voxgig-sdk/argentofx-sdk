...
class ArgentofxTestRunner
{
    ...
    {
        $live = self::getenv('ARGENTOFX_TEST_LIVE');
        $override = self::getenv('ARGENTOFX_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ARGENTOFX_TEST_EXPLAIN');
...
class_alias('ArgentofxTestRunner', 'Runner');
class_alias('ArgentofxHelpers', 'Helpers');
