...
// Argentofx SDK streaming feature
...
class ArgentofxStreamingFeature extends ArgentofxBaseFeature
{
    ...
    private function _iterate(ArgentofxResult $result): \Generator
    {
    ...
    private function _streamable(ArgentofxContext $ctx): bool
    {
