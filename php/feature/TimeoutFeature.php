...
class ArgentofxTimeoutFeature extends ArgentofxBaseFeature
{
    ...
    private function _with_timeout(ArgentofxContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ArgentofxContext $_ctx, float $ms): void
    {
        $client = $this->client;
