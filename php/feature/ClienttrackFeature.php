...
// Argentofx SDK clienttrack feature
...
class ArgentofxClienttrackFeature extends ArgentofxBaseFeature
{
    ...
    public function PostConstruct(ArgentofxContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Argentofx-SDK';
