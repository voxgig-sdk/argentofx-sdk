...
class ArgentofxProxyFeature extends ArgentofxBaseFeature
{
    ...
    public function init(ArgentofxContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ArgentofxContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
