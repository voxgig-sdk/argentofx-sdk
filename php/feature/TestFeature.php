...
// Argentofx SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ArgentofxTestFeature extends ArgentofxBaseFeature
{
    ...
    public function init(ArgentofxContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ArgentofxContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = ArgentofxParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ArgentofxContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ArgentofxContext $ctx, $op, $args): array
    {
