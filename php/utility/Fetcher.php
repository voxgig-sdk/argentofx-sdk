...
// Argentofx SDK utility: fetcher

class ArgentofxFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ArgentofxSDK/1.0)';
    ...
    public static function call(ArgentofxContext $ctx, string $fullurl, array $fetchdef): array
    {
