...
class ArgentofxGraphql
{
    ...
    // equivalent.
    public static function body(ArgentofxContext $ctx): mixed
    {
    ...
    public static function errors(ArgentofxContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
