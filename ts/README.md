# Argentofx TypeScript SDK



The TypeScript SDK for the Argentofx API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Currency()` — each with a small set of operations (`list`, `load`)
...
| `tester(testopts?, sdkopts?)` | `ArgentofxSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `ArgentofxSDK.test(testopts?, sdkopts?)` | `ArgentofxSDK` | Create a test-mode client. |
...
argentofx/
├── src/
│   ├── ArgentofxSDK.ts        # Main SDK class
