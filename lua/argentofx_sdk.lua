...
local ArgentofxSDK = {}
ArgentofxSDK.__index = ArgentofxSDK
...
ArgentofxSDK._make_feature = _make_feature


function ArgentofxSDK.new(options)
  local self = setmetatable({}, ArgentofxSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function ArgentofxSDK:options_map()
...
function ArgentofxSDK:get_utility()
  return Utility.copy(self._utility)
end


function ArgentofxSDK:get_root_ctx()
  return self._rootctx
end


function ArgentofxSDK:prepare(fetchargs)
...
function ArgentofxSDK:direct(fetchargs)
...
-- by passing it.
function ArgentofxSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function ArgentofxSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "ArgentofxSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function ArgentofxSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = ArgentofxSDK.new(sdkopts)
  sdk.mode = "test"
