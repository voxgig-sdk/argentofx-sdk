...
local DollarQuoteEntity = {}
DollarQuoteEntity.__index = DollarQuoteEntity


function DollarQuoteEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DollarQuoteEntity)
  self._name = "dollar_quote"
  self._client = client
...
function DollarQuoteEntity:get_name()
  return self._name
end


function DollarQuoteEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DollarQuoteEntity.new(self._client, opts)
end
...
function DollarQuoteEntity:mark_deleted()
  self._deleted = true
end


function DollarQuoteEntity:deleted()
  return true == self._deleted
end


function DollarQuoteEntity:data_set(args)
  if args ~= nil then
...
function DollarQuoteEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DollarQuoteEntity:match_set(args)
  if args ~= nil then
...
function DollarQuoteEntity:match_get()
...
function DollarQuoteEntity:stream(action, args, callopts)
...
---@param reqmatch DollarQuoteLoadMatch
---@param ctrl? table
---@return DollarQuote
---@return string? err
function DollarQuoteEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch DollarQuoteListMatch
---@param ctrl? table
---@return DollarQuote[]
---@return string? err
function DollarQuoteEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function DollarQuoteEntity:_run_op(ctx, post_done)
  local utility = self._utility
