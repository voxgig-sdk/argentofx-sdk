...
// Argentofx SDK ratelimit feature
...
class ArgentofxRatelimitFeature extends ArgentofxBaseFeature
{
    ...
    private function _acquire(ArgentofxContext $ctx): void
    {
    ...
    private function _track(ArgentofxContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
