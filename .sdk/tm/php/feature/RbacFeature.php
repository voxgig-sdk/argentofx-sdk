...
class ArgentofxRbacFeature extends ArgentofxBaseFeature
{
    ...
    private function _required(ArgentofxContext $ctx): ?string
    {
    ...
    private function _reject(ArgentofxContext $ctx, string $required): void
    {
    ...
    private function _track(ArgentofxContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
