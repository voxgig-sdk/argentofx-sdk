...
class ArgentofxNetsimFeature extends ArgentofxBaseFeature
{
    ...
    private function _simulate(ArgentofxContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ArgentofxContext $ctx, array $applied): void
    {
        $client = $this->client;
