...
class ArgentofxCacheFeature extends ArgentofxBaseFeature
{
    ...
    private function _through(ArgentofxContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
