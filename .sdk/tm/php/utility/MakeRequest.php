...
// Argentofx SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ArgentofxMakeRequest
{
    public static function call(ArgentofxContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ArgentofxResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ArgentofxResponse($fetched);
        } else {
