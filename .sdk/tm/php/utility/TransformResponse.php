...
// Argentofx SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ArgentofxTransformResponse
{
    public static function call(ArgentofxContext $ctx): mixed
    {
        ...
        $transform = ArgentofxHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
