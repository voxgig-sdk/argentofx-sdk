# Argentofx SDK primary utility test
...
from projectname_sdk import ArgentofxSDK
from projectname_sdk.core.spec import ArgentofxSpec
from projectname_sdk.core.result import ArgentofxResult
from projectname_sdk.core.response import ArgentofxResponse
from projectname_sdk.core.operation import ArgentofxOperation
from projectname_sdk.core.error import ArgentofxError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import ArgentofxBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return ArgentofxError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = ArgentofxSDK.test(None, None)
        ...
        class TestInitFeature(ArgentofxBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ArgentofxBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = ArgentofxSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ArgentofxSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ArgentofxSDK.test(None, setup_opts)
