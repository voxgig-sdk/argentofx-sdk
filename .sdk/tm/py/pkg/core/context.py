...
from projectname_sdk.core.control import ArgentofxControl
...
class ArgentofxContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, ArgentofxSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ArgentofxResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ArgentofxResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ArgentofxError(code, msg, self)
