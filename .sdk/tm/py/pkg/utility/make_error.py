# Argentofx SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, ArgentofxError):
        errmsg = err.msg
    ...
    msg = "ArgentofxSDK: " + opname + ": " + errmsg
    ...
    sdk_err = ArgentofxError("", msg, ctx)
