...
func registerSDKWords(r *eng.Registry, client *sdk.ArgentofxSDK) {
...
func runOp(client *sdk.ArgentofxSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
