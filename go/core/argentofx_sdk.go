...
func (sdk *ArgentofxSDK) OptionsMap() map[string]any {
...
func (sdk *ArgentofxSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ArgentofxSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ArgentofxSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ArgentofxSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ArgentofxSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ArgentofxSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ArgentofxSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ArgentofxSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ArgentofxSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ArgentofxSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
