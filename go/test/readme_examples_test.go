...
const testSeed = `map[string]any{"entity": map[string]any{"currency": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "dollar_quote": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_root": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
