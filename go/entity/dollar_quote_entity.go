...
func NewDollarQuoteEntity(client *core.ArgentofxSDK, entopts map[string]any) *DollarQuoteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DollarQuoteEntity) GetName() string { return e.name }
...
func (e *DollarQuoteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DollarQuoteEntity) Deleted() bool {
	return e.deleted
}


func (e *DollarQuoteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDollarQuoteEntity(e.client, opts)
}

func (e *DollarQuoteEntity) Data(args ...any) any {
...
func (e *DollarQuoteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DollarQuote; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DollarQuoteEntity) DataTyped(data ...DollarQuote) DollarQuote {
	if len(data) > 0 {
		return typedFrom[DollarQuote](e.Data(asMap(data[0])))
	}
	return typedFrom[DollarQuote](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DollarQuote (all fields
// optional at the wire level).
func (e *DollarQuoteEntity) MatchTyped(match ...DollarQuote) DollarQuote {
	if len(match) > 0 {
		return typedFrom[DollarQuote](e.Match(asMap(match[0])))
	}
	return typedFrom[DollarQuote](e.Match())
}
...
func (e *DollarQuoteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DollarQuoteEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DollarQuoteLoadMatch and returns an DollarQuote. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DollarQuoteEntity) LoadTyped(reqmatch DollarQuoteLoadMatch, ctrl map[string]any) (DollarQuote, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return DollarQuote{}, err
	}
	return typedFrom[DollarQuote](res), nil
}




func (e *DollarQuoteEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// DollarQuoteListMatch and returns []DollarQuote. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DollarQuoteEntity) ListTyped(reqmatch DollarQuoteListMatch, ctrl map[string]any) ([]DollarQuote, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[DollarQuote](res), nil
}



func (e *DollarQuoteEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DollarQuoteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DollarQuoteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DollarQuoteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
