# Argentofx Golang SDK Reference

Complete API reference for the Argentofx Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *ArgentofxSDK`
...
#### `Currency(data map[string]any) ArgentofxEntity`

Create a new `Currency` entity instance. Pass `nil` for no initial data.

#### `DollarQuote(data map[string]any) ArgentofxEntity`

Create a new `DollarQuote` entity instance. Pass `nil` for no initial data.

#### `GetRoot(data map[string]any) ArgentofxEntity`
