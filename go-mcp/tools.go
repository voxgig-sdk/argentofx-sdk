...
type Args struct {
	Entity string         `json:"entity" jsonschema:"currency | dollar_quote | get_root"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ArgentofxSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "argentofx_list",
		Description: "List records from Argentofx. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "argentofx_load",
		Description: "Load a single record from Argentofx. " +
...
func runOp(client *sdk.ArgentofxSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ArgentofxSDK, name string) (sdk.ArgentofxEntity, error) {
	switch strings.ToLower(name) {
	case "currency":
		return client.Currency(nil), nil
	case "dollar_quote":
		return client.DollarQuote(nil), nil
	case "get_root":
